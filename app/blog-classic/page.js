      ...
      >
        ...
        <div className="sidebar-page-container">
          ...
          <div
            ...
            style={{ backgroundImage: "url(assets/images/icons/icon-2.png)" }}
          ></div>
          <div
            className="icon-layer-three"
            style={{ backgroundImage: "url(assets/images/icons/icon-3.png)" }}
          ></div>
                    ...
                    <div className="inner-box">
                      ...
                      <div className="lower-content">
                        ...
                        <ul className="post-info">
                          ...
                          <li>2 Comments</li>
                          <li>
                            <Link href="news-detail">Share</Link>
                          </li>
                        </ul>
                        <div className="text">
                  ...
                  <div className="news-block-three">
                    <div className="inner-box">
                      <div className="lower-content">
                        <div className="category">smoothie</div>
                        <h3>
                          <Link href="news-detail">Breakfast At Hotel</Link>
                        </h3>
                        <ul className="post-info">
                          <li>May 21, 2021</li>
                          <li>2 Comments</li>
                ...
                <aside className="sidebar sticky-top">
                  ...
                  <div className="sidebar-widget about-widget">
                    <div className="widget-content">
                      ...
                      <div className="text">
                        Pellentesque semper ut sem non aliquet. Nullam tincidunt
                        vestibulum condimentum. Duis at mollis orci. Nulla
                        facilisi. Pellentesque in mi ut diam consequat
                        sollicitudin
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="sidebar-widget category-widget">
                    <div className="widget-content">
                      ...
                      <ul className="cat-list">
                        ...
                        <li>
                          <Link href="#">Fruit Bowl</Link>
                        </li>
                        <li>
                          <Link href="#">Healthy</Link>
                        </li>
                        <li>
                          <Link href="#">Ice Cream</Link>
                        </li>
                        <li>
                          <Link href="#">Mixed</Link>
                        </li>
                        <li>
                          <Link href="#">Shakes</Link>
                        </li>
                        <li>
                          <Link href="#">Smoothie</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                      ...
                      <article className="post">
                        <figure className="post-thumb">
                          <img
                            ...
                            alt=""
                          />
                          <Link href="news-detail" className="overlay-box">
                            <span className="icon fa fa-link"></span>
                          </Link>
                        </figure>
                        <div className="text">
                          <Link href="news-detail">Hippie Chick</Link>
                        </div>
                  ...
                  <div className="sidebar-widget social-widget">
                    ...
                    <ul className="social-list">
                      ...
                      <li>
                        <Link href="#">
                          <span className="icon fa fa-dribbble"></span>
                        </Link>
                      </li>
                    </ul>
                  </div>
