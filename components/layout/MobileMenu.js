      ...
      <div className="mobile-menu">
        ...
        <nav className="menu-box">
          <div className="nav-logo">
            <Link href="/">
              <img src="assets/images/logohe.png" alt="" title="" />
            </Link>
          </div>
              ...
              <ul className="navigation">
                ...
                >
                  ...
                  >
                    ...
                    <li>
                      <Link href="milkshake">Milk Shake</Link>
                    </li>
                    <li>
                      <Link href="frappe">Frappe</Link>
                    </li>
                    <li>
                      <Link href="boba-tea">Boba Tea</Link>
                    </li>
                    <li>
                      <Link href="slushy">Slushy</Link>
                    </li>
                  </ul>
                  <div
                    className={
                ...
                >
                  ...
                  >
                    ...
                    <li>
                      <Link href="blog-details2">Blog Single 02</Link>
                    </li>
                    <li>
                      <Link href="blog-details">Blog Details</Link>
                    </li>
                    <li>
                      <Link href="/error">Not Found</Link>
                    </li>
                  </ul>
                  <div
                    className={
