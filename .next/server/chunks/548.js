...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(8770));
...
const _requestcookies = __webpack_require__(3760);
const _headers = __webpack_require__(5190);
const _cookies = __webpack_require__(2439);
const _requestasyncstorage = __webpack_require__(9094);
const _actionasyncstorage = __webpack_require__(43);
const _staticgenerationbailout = __webpack_require__(5903);
const _draftmode = __webpack_require__(5688);
function headers() {
...
let chalk;
if (false) {} else {
    chalk = __webpack_require__(7109);
}
...
const _headers = __webpack_require__(5190);
const _constants = __webpack_require__(1391);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(7486);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(7486);
...
const _apiutils = __webpack_require__(5994);
...
const _requestcookies = __webpack_require__(3760);
const _cookies = __webpack_require__(2439);
const _draftmodeprovider = __webpack_require__(8219);
...
const _http = __webpack_require__(1125);
const _responsehandlers = __webpack_require__(7982);
...
const _cookies = __webpack_require__(8669);
const _nexturl = __webpack_require__(2148);
const _cleanurl = __webpack_require__(7640);
...
const _notfound = __webpack_require__(7188);
const _redirect = __webpack_require__(6794);
const _responsehandlers = __webpack_require__(7982);
...
const _routemodule = __webpack_require__(5741);
const _requestasyncstoragewrapper = __webpack_require__(6907);
const _staticgenerationasyncstoragewrapper = __webpack_require__(154);
const _responsehandlers = __webpack_require__(7982);
const _http = __webpack_require__(1125);
const _patchfetch = __webpack_require__(9780);
const _tracer = __webpack_require__(9192);
const _constants = __webpack_require__(1059);
const _getpathnamefromabsolutepath = __webpack_require__(489);
const _proxyrequest = __webpack_require__(5022);
const _resolvehandlererror = __webpack_require__(8521);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(6710));
const _autoimplementmethods = __webpack_require__(4337);
const _getnonstaticmethods = __webpack_require__(4439);
const _requestcookies = __webpack_require__(3760);
const _routekind = __webpack_require__(3495);
const _parsedurlquerytoparams = __webpack_require__(5810);
...
const headerHooks = __webpack_require__(9290);
...
const _detectdomainlocale = __webpack_require__(9140);
const _formatnextpathnameinfo = __webpack_require__(3122);
const _gethostname = __webpack_require__(6400);
const _getnextpathnameinfo = __webpack_require__(2994);
...
const _formatnextpathnameinfo = __webpack_require__(8402);
const _gethostname = __webpack_require__(1683);
const _getnextpathnameinfo = __webpack_require__(8791);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _reflect = __webpack_require__(7443);
...
const _cookies = __webpack_require__(3784); //# sourceMappingURL=cookies.js.map
...
const _cookies = __webpack_require__(8669); //# sourceMappingURL=cookies.js.map
...
const _nexturl = __webpack_require__(6425);
const _utils = __webpack_require__(624);
const _error = __webpack_require__(4982);
const _cookies = __webpack_require__(8234);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(7616));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(1671);
const _pathhasprefix = __webpack_require__(2847);
...
const _addpathprefix = __webpack_require__(7634);
const _pathhasprefix = __webpack_require__(6317);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _parsepath = __webpack_require__(6210);
...
const _parsepath = __webpack_require__(1220);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
const _removetrailingslash = __webpack_require__(3215);
const _addpathprefix = __webpack_require__(1671);
const _addpathsuffix = __webpack_require__(2573);
const _addlocale = __webpack_require__(3498);
...
const _addpathprefix = __webpack_require__(7634);
const _addpathsuffix = __webpack_require__(8221);
const _addlocale = __webpack_require__(2762);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _normalizelocalepath = __webpack_require__(5090);
const _removepathprefix = __webpack_require__(1652);
const _pathhasprefix = __webpack_require__(2847);
...
const _removepathprefix = __webpack_require__(4247);
const _pathhasprefix = __webpack_require__(6317);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
...
const serverExports = {
    NextRequest: (__webpack_require__(8382).NextRequest),
    NextResponse: (__webpack_require__(7820)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(6253)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(9471).userAgentFromString),
    userAgent: (__webpack_require__(9471).userAgent)
};
